...
import { ArrowLeft, ArrowRightLeft, ChevronRight, Users } from 'lucide-react';
...
export default function TeamDetail() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto space-y-4">
      <Link to="/" className="inline-flex items-center gap-1.5 text-[11px] text-[#75757f] hover:text-white active:text-white transition-colors">
